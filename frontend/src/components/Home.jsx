        ...
        >
          ...
          <div className="flex flex-col items-center relative z-10">
            ...
            <div className="flex items-center gap-1 ">
              ...
              {/* XP BAR */}
              <div
                className="w-8 h-2 bg-[#123C7A] border border-blue-800 
  ...
  "
        >
          <img
            src={leftIcon1}
            alt=""
            className="h-8 sm:h-10 md:h-12 rounded-xl border-2 border-yellow-200 cursor-pointer hover:scale-105 transition"
          />
          <img
            src={leftIcon2}
            alt=""
        ...
        <img
          src={ludo}
          alt=""
          className="h-32 sm:h-36 md:h-40 sm:mt-10 mt-12"
        />
  ...
  "
      ...
      <div className="mt-5 grid grid-cols-3 sm:grid-cols-3 gap-4 sm:gap-6">
        ...
        >
          <div className="w-28 md:w-40 rounded-2xl overflow-hidden shadow-lg shadow-black border-2 border-yellow-600 transition-all duration-300 hover:scale-105 hover:shadow-yellow-300/40 hover:shadow-xl">
            ...
            <div className="bg-yellow-600 text-center py-2 border-t-2 border-yellow-500">
              <span className="text-white [text-shadow:_-1px_-1px_0_#000,_1px_-1px_0_#000,_-1px_1px_0_#000,_1px_1px_0_#000] font-bold text-lg ">
                Online
              </span>
            </div>
          </div>
          <div className="flex justify-center items-center gap-1 text-xs mt-1">
            ...
            <p className="text-green-400 [text-shadow:_-1px_-1px_0_#000,_1px_-1px_0_#000,_-1px_1px_0_#000,_1px_1px_0_#000] font-semibold">
              Players:74,069
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div className="flex justify-center items-center gap-1 text-xs mt-1">
            <FaCircle className="text-green-500" />
            <p className="text-green-300 [text-shadow:_-1px_-1px_0_#000,_1px_-1px_0_#000,_-1px_1px_0_#000,_1px_1px_0_#000] font-semibold">
              Players:5,567
            </p>
          </div>
        </div>
      ...
      <div className="flex flex-col justify-center items-center w-full mt-2">
        ...
        <div className="flex items-center justify-center gap-6 sm:gap-10">
          <div className="border-4 border-yellow-300 rounded-xl p-1 sm:p-1 cursor-pointer hover:scale-105 transition">
            <img src={dice} alt="Dice" className="h-8 sm:h-10" />
          </div>
          ...
          {/* Snake Button */}
          <div className="border-4 border-yellow-300 rounded-xl p-1 sm:p-1 cursor-pointer hover:scale-105 transition">
            <img src={snake} alt="Snake" className="h-8 sm:h-10" />
          </div>
        </div>
