...
function HomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center py-4" style={{ backgroundImage: `url(${backgroundImg})` }}>

{/* ---- TOP NAVBAR ---- */}
<div className="w-full px-3 pt-2">
  <div className="relative flex items-center 
  bg-gradient-to-r from-[#083A87] via-[#0A4FBF] to-[#4DA6FF]
  border-2 border-yellow-300 rounded-xl px-2 py-1 overflow-visible">
...
<div className="flex flex-col items-center relative z-10">
  ...
  <div className="flex items-center gap-1 mt-1">
    ...
    {/* XP BAR */}
    <div className="w-16 h-2 bg-[#123C7A] border border-blue-800 
...
<div className="mt-7 relative w-full flex justify-center">
  ...
  <div className="
      ...
      flex flex-col 
      gap-3 sm:gap-4 md:gap-5 sm:mt-10 mt-7
  ">
  ...
  {/* MAIN LUDO LOGO */}
  <img src={ludo} alt="" className="h-32 sm:h-36 md:h-40" />
      ...
      {/* ---------- MAIN BUTTONS ---------- */}
        <div className="mt-5 grid grid-cols-3 sm:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div className="flex flex-col items-center cursor-pointer">
            <div className="w-32 sm:w-36 md:w-40 rounded-2xl overflow-hidden shadow-md shadow-black border-2 border-yellow-300 transition-all duration-300 hover:scale-105 hover:shadow-yellow-300/40 hover:shadow-xl">
              <div className="bg-blue-700 flex justify-center items-center py-3">
                <ImMobile className="text-3xl text-white" />
              </div>
              <div className="bg-yellow-400 text-center py-2 border-t-2 border-yellow-300">
                <span className="text-white font-bold text-lg hover:text-black">Online</span>
              </div>
            </div>
            <div className="flex justify-center items-center gap-1 text-xs mt-1">
              <FaCircle className="text-green-500"/>
               <p className="text-green-400 font-semibold">Players:74,069</p>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center cursor-pointer">
            <div className="w-32 sm:w-36 md:w-40 rounded-2xl  overflow-hidden shadow-md shadow-black border-2 border-yellow-300 transition-all duration-300 hover:scale-105 hover:shadow-yellow-300/40 hover:shadow-xl">
              ...
              <div className="bg-yellow-400 text-center py-2 border-t-2 border-yellow-300">
                <span className="text-white font-bold text-lg hover:text-black">Team Up</span>
              </div>
            </div>
            <div className="flex justify-center items-center gap-1 text-xs mt-1">
              <FaCircle className="text-green-500"/>
               <p className="text-green-400 font-semibold">Players:2,168</p>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center cursor-pointer">
            <div className="w-32 sm:w-36 md:w-40 rounded-2xl overflow-hidden shadow-md shadow-black border-2 border-yellow-300 transition-all duration-300 hover:scale-105 hover:shadow-yellow-300/40 hover:shadow-xl">
              ...
              <div className="bg-yellow-400 text-center py-2 border-t-2 border-yellow-300">
                <span className="text-white font-bold text-lg hover:text-black">Friends</span>
              </div>
            </div>
            <div className="flex justify-center items-center gap-1 text-xs mt-1">
              <FaCircle className="text-green-500"/>
               <p className="text-green-400 font-semibold">Players:5,567</p>
            </div>
          </div>
          ...
          <div className="col-span-3  flex justify-center sm:gap-20 gap-8 mt-1 cursor-pointer">
            ...
            <div className="flex flex-col items-center">
              <div className="w-32 sm:w-36 md:w-40 rounded-2xl overflow-hidden shadow-md shadow-black border-2 border-yellow-300 transition-all duration-300 hover:scale-105 hover:shadow-yellow-300/40 hover:shadow-xl">
                ...
                <div className="bg-yellow-400 text-center py-2 border-t-2 border-yellow-300">
                  <span className="text-white font-bold text-lg hover:text-black">Computer</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center">
              <div className="w-32 sm:w-36 md:w-40 rounded-2xl overflow-hidden shadow-md shadow-black border-2 border-yellow-300 transition-all duration-300 hover:scale-105 hover:shadow-yellow-300/40 hover:shadow-xl">
                ...
                <div className="bg-yellow-400 text-center py-2 border-t-2 border-yellow-300">
                  <span className="text-white font-bold text-lg hover:text-black">Pass N Play</span>
                </div>
              </div>
            </div>
...
{/* ---------- BOTTOM NAVIGATION ---------- */}
<div className="fixed bottom-0 left-0 right-0 bg-blue-800 py-2 flex text-white border-t-2 border-yellow-300 shadow-xl">
  ...
  <div className="flex-1 flex items-center justify-center cursor-pointer">
    <div
      className="flex flex-col items-center justify-center 
                 ...
                 transition-all 
                 px-4 py-2"  // ACTIVE — NORMAL PADDING
  ...
  <div className="flex-1 flex items-center justify-center cursor-pointer">
    <div
      className="flex flex-col items-center justify-center 
                 ...
                 px-3 py-1 hover:px-4 hover:py-2 
                 hover:bg-blue-700"
  ...
  <div className="flex-1 flex items-center justify-center cursor-pointer">
    ...
    >
      <FaComments className="text-yellow-300 text-2xl" />
  ...
  <div className="flex-1 flex items-center justify-center cursor-pointer">
    ...
    >
      <FaDice className="text-yellow-300 text-2xl" />
  ...
  <div className="flex-1 flex items-center justify-center cursor-pointer relative">
    ...
    >
      <FaShoppingCart className="text-yellow-300 text-2xl" />
